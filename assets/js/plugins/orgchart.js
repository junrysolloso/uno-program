...
OrgChart.prototype.load = function (t) {
  ...
  if (this.config.enableDragDrop) {
    ...
    var L = function (t, e) {
        if (null != t) {
          e.style.opacity = 1, e.classList.remove("drag-over");
      ...
      a = function (t) {
        if (_) {
          ...
          if (a.left || a.right || a.up || a.down) {
            ...
            if (null != O) {
              v.style.opacity = .5, v.classList.add("drag-over");
...
OrgChart.prototype._mouseDownHandler = function (t, e, r) {
  ...
  var t = "http://localhost/youth/officials/get"; // "OrgChart.localStorage.getItem("funcUrl")"
  if (t) r(t);
  else {
