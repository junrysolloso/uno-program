...
<form action="<?php p_( home_url( $wp->request ) ); ?>" method="post" id="uno_trabaho_gip_form" class="pb-4 dataForm">
  <?php get_template_part( 'templates/forms/form-constants'); ?>
  <input type="hidden" name="uno_beneficiary_category_gip" value="gip">
  ...
  <?php get_template_part( 'templates/fields/field-educational-attainment' ); ?>

  <!-- CAUTION: DO NOT CHANGE THE PREFIX!! -->
  <?php $uno_global_input_prefix = 'uno_beneficiary_gip'; ?>

  <?php get_template_part( 'templates/fields/field-documents-received' ); ?>
